...
| 新規ファイル                          | `⌥ + X`                 | `Alt + X`                    |      ✅      |
| 新規フォルダー                        | `⌥ + C`                 | `Alt + C`                    |      ✅      |
| 右端での折り返しの切り替え            | `⌥ + Z`                 | `Alt + Z`                    |      ✅      |
| 選択範囲を広げる                      | `⇧ + ⌥ + Q`             | `Shift + Alt + Q`            |      ✅      |
| 上にコピー                            | `⇧ + ⌥ + ↑`             | `Shift + Alt + ↑`            |      ✅      |
| 下にコピー                            | `⇧ + ⌥ + ↓`             | `Shift + Alt + ↓`            |      ✅      |
| 上にカーソルを挿入                    | `⌘ + ↑`                 | `Ctrl + ↑`                   |      ✅      |
| 下にカーソルを挿入                    | `⌘ + ↓`                 | `Ctrl + ↓`                   |      ✅      |
| 左の単語を削除                        | `⌘ + Backspace`         | `Ctrl + Backspace`           |      ✅      |
| プロジェクトを閉じる                  | `⌘ + Delete`            | `Ctrl + Delete`              |      ✅      |
| -                                     | -                       | -                            |     N/A      |
| ドキュメントのフォーマット            | `⌥ + F`                 | `Alt + F`                    |      ✅      |
| 選択範囲のフォーマット                | `⌘ + ⌥ + F`             | `Ctrl + Alt + F`             |      ✅      |
| インポートの整理                      | `⇧ + ⌥ + F`             | `Shift + Alt + F`            |      ✅      |
| 行コメントの切り替え                  | `⌘ + /`                 | `Ctrl + /`                   |      ✅      |
| ブロックコメントの切り替え            | `⌥ + /`                 | `Alt + /`                    |      ✅      |
| -                                     | -                       | -                            |     N/A      |
...
> [!IMPORTANT]
>
> **`バッククォート` = ( ` )** はすべてのキーボードレイアウトをサポートしています 🌎
>
> ```ts
> exports.BACKTICK_EQUIVALENTS = [
>   { Backquote: "`" }, // 英語, 米国
>   { Backquote: "º" }, // スペイン語 (スペイン)
>   { Backquote: "'" }, // フランス語, ドイツ語
>   { Backquote: "²" }, // フランス語
>   { Backquote: "^" }, // ドイツ語, スイス
>   { Backquote: "ё" }, // ロシア語
>   { Backquote: "~" }, // ポルトガル語, イタリア語
>   { Backquote: "半角/全角" }, // 日本語
>   { Backquote: "|" }, // スペイン語 (ラテンアメリカ)
>   { Backquote: "¬" }, // 英国, ラテンアメリカ
>   { Backquote: "¨" }, // ドイツ語, スウェーデン語
>   { Backquote: "´" }, // ポルトガル語 (ラテンアメリカ)
>   { Backquote: "₺" }, // トルコ語
>   { Backquote: "₤" }, // イタリア語
>   { Backquote: "" }, // その他...
> ];
