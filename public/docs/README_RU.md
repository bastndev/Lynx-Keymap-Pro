...
![Экспериментально — Новинка](https://raw.githubusercontent.com/bastndev/Lynx-Keymap-pro/refs/heads/main/public/github/images/img/t-3.webp)
...
<details>
<summary>🖼️ (Нажмите) Посмотреть скриншот</summary>
<br>
...
## 🎛️ Компактный режим — 75%

> Нажмите **`Alt + 0`** для переключения между стандартным и **компактным** раскладом — разработанным для клавиатур без ряда функциональных клавиш или блока стрелок. Следующие сочетания активны только при включённом компактном режиме.

| Команда                        | 🍎 macOS        | 🟦 Windows            | 🐧 Linux              |
| :----------------------------- | :-------------- | :-------------------- | :-------------------- |
| Просмотр изменений Git         | `PageUp`        | `PageUp`              | `PageUp`              |
| Предпросмотр Markdown          | `PageDown`      | `PageDown`            | `PageDown`            |
| -                              | -               | -                     | -                     |
...
| -                              | -               | -                     | -                     |
| Увеличить масштаб ( 🛞 право ) | `⇧ + ⌥ + Vol +` | `Shift + Alt + Vol +` | `Shift + Alt + Vol +` |
| Уменьшить масштаб ( 🛞 лево )  | `⇧ + ⌥ + Vol -` | `Shift + Alt + Vol -` | `Shift + Alt + Vol -` |
...
<h2 align="center">⌨️ Общие сочетания клавиш — Pro</h2>
...
| Переключить консоль отладки (REPL)      | `⌥ + Q`                 | `Alt + Q`                    |       ✅       |
| -                                       | -                       | -                            |      N/A       |
| Новый файл                              | `⌥ + X`                 | `Alt + X`                    |       ✅       |
| Новая папка                             | `⌥ + C`                 | `Alt + C`                    |       ✅       |
...
| -                                       | -                       | -                            |      N/A       |
| Панель CLI (переключить)                | `⌥ + E`                 | `Alt + E`                    |       ✅       |
| Терминал лево/право (переключить)       | `⌥ + CapsLock`          | `Alt + CapsLock`             |       ✅       |
| Восстановить раскладку по умолчанию     | `⌘ + ⌥ + CapsLock`      | `Ctrl + Alt + CapsLock`      |       ✅       |
| Быстро открыть терминал                 | `⌥ + W`                 | `Alt + W`                    |       ✅       |
| Максимизировать / Минимизировать панель | <code>⌘ + \`</code>     | <code>Ctrl + \`</code>       |       ✅       |
| Закрыть терминал                        | <code>⌘ + ⌥ + \`</code> | <code>Ctrl + Alt + \`</code> |       ✅       |
| Терминал — Очистить строку              | `⌘ + ⌥ + Backspace`     | `Ctrl + Alt + Backspace`     |       ✅       |
| Терминал — Дополнить слово              | `⌘ + ,`                 | `Ctrl + ,`                   |       ✅       |
| -                                       | -                       | -                            |      N/A       |
| **Умное закрытие** — ИИ или терминал    | `⌘ + Tab`               | `Ctrl + Tab`                 |       ✅       |
| Создать новую сессию ИИ                 | `⌥ + A`                 | `Alt + A`                    |       ✅       |
| Показать историю чата ИИ                | `⌥ + S`                 | `Alt + S`                    |       ✅       |
| Выделить код для ИИ                     | `⌥ + D`                 | `Alt + D`                    |       ✅       |
| -                                       | -                       | -                            |      N/A       |
| Отменить встроенный чат                 | `⌥ + Return`            | `Alt + Enter`                |       ✅       |

> **Умное закрытие** (`Ctrl + Tab`) учитывает контекст:
>
> - Если **терминал** занимает боковую панель → закрывает терминал.
> - В противном случае → открывает / закрывает **чат ИИ**.
...
> Чтобы использовать эти команды, сначала необходимо перейти в **Управление версиями** (так как они не работают напрямую) или нажать сочетание клавиш **_`Ctrl + 2`_**.

| Команда                        | 🍎 macOS                | 🟦 Windows                       | 🐧 Linux                         |
| :----------------------------- | :---------------------- | :------------------------------- | :------------------------------- |
| Индексировать все              | `⌥ + 1`                 | `Alt + 1`                        | `Alt + 1`                        |
| Создать сообщение коммита (ИИ) | `⌥ + 2`                 | `Alt + 2`                        | `Alt + 2`                        |
| Отменить индексацию всех       | `⌥ + 3`                 | `Alt + 3`                        | `Alt + 3`                        |
| Закоммитить                    | `⌥ + Return`            | `Alt + Enter`                    | `Alt + Enter`                    |
| Пуш                            | `⌘ + ⌥ + Return`        | `Ctrl + Alt + Enter`             | `Ctrl + Alt + Enter`             |
| Просмотреть изменения Git      | `⌥ + L`                 | `Alt + L`                        | `Alt + L`                        |
...
| Команда                        | 🍎 macOS          | 🟦 Windows              | 🐧 Linux                |
| :----------------------------- | :---------------- | :---------------------- | :---------------------- |
| Открыть настройки (интерфейс)  | `⌘ + J`           | `Ctrl + J`              | `Ctrl + J`              |
| Открыть настройки (JSON)       | `⌥ + J`           | `Alt + J`               | `Alt + J`               |
| Выбрать тему                   | `⇧ + ⌥ + T`       | `Shift + Alt + T`       | `Shift + Alt + T`       |
| Перезагрузить окно             | `⇧ + ⌥ + R`       | `Shift + Alt + R`       | `Shift + Alt + R`       |
| Показать предпросмотр Markdown | `⌥ + M`           | `Alt + M`               | `Alt + M`               |
| Переключить раскладку          | `⌥ + 0`           | `Alt + 0`               | `Alt + 0`               |
| Увеличить масштаб              | `⇧ + ⌥ + VolUp`   | `Shift + Alt + VolUp`   | `Shift + Alt + VolUp`   |
| Уменьшить масштаб              | `⇧ + ⌥ + VolDown` | `Shift + Alt + VolDown` | `Shift + Alt + VolDown` |
...
| Умный новый терминал         | <code>⌘ + ⇧ + `</code> | <code>Ctrl + Shift + `</code> | <code>Ctrl + Shift + `</code> |
...
>   { Backquote: "`" }, // Английский, США
>   { Backquote: "º" }, // Испанский (Испания)
>   { Backquote: "'" }, // Французский, Немецкий
>   { Backquote: "²" }, // Французский
>   { Backquote: "^" }, // Немецкий, Швейцарский
>   { Backquote: "ё" }, // Русский
>   { Backquote: "~" }, // Португальский, Итальянский
>   { Backquote: "半角/全角" }, // Японский
>   { Backquote: "|" }, // Испанский (Латинская Америка)
>   { Backquote: "¬" }, // Великобритания, Латинская Америка
>   { Backquote: "¨" }, // Немецкий, Шведский
>   { Backquote: "´" }, // Португальский (Латинская Америка)
>   { Backquote: "₺" }, // Турецкий
>   { Backquote: "₤" }, // Итальянский
>   { Backquote: "" }, // И ДРУГИЕ...
> ];
> ```
...
> [!NOTE]
>
> ### Отключённые стандартные сочетания клавиш
>
...
|                         _Создатель и разработчик_                         |

- 🐦 **[X](https://x.com/intent/follow?screen_name=gohitx)** : Для вопросов и обсуждений.
- 🌱 **[IG](https://instagram.com/gohitx)** : **`новое`** – Превью проектов и новости.
- 🔴 **[YouTube](https://www.youtube.com/@gohitx?sub_confirmation=1)** : Код, ПО и инсайты разработки.
...
| ----------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![F1](https://open-vsx.org/api/bastndev/f1/1.0.0/file/icon.png)](https://open-vsx.org/extension/bastndev/f1)                             | [F1](https://github.com/bastndev/F1)                     | Идеальный центр управления ИИ. Централизуйте Claude, Copilot или Cursor в интерактивных терминалах, создавайте пользовательские рабочие процессы с помощью 'My Skills' и давайте ИИ мгновенный контекст кода с 'My Memory'. |
| [![Lynx Theme Pro](https://open-vsx.org/api/bastndev/lynx-theme/5.0.0/file/icon.png)](https://open-vsx.org/extension/bastndev/lynx-theme) | [Lynx Theme Pro](https://github.com/bastndev/Lynx-Theme) | Профессиональное расширение с шестью доступными темами: Dark, Light, Night, Ghibli, Coffee и Kiro — с интегрированными иконками. Каждая тема оптимизирована для приятного визуального восприятия.                       |
