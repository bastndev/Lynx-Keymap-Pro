...
<h2 align="center">Lynx Keymap Pro — <b>Référence des Raccourcis Clavier</b></h2>

> Optimisé pour les **claviers Pro** sur VSCode · Cursor · Windsurf · Trae-ai · Kiro · Antigravity & Firebase.studio.

---

<br>

![Expérimental — Nouveau](https://raw.githubusercontent.com/bastndev/Lynx-Keymap-pro/refs/heads/main/public/github/images/img/t-3.webp)
...
<details>
<summary>🖼️ (𝗖𝗹𝗶𝗾𝘂𝗲𝘇) Voir la Capture d'écran</summary>
<br>
...
> Appuyez sur **`Alt + 0`** pour basculer entre la disposition standard et la **disposition compacte** — conçue pour les claviers sans rangée de fonctions (F-keys) ni bloc fléché. Les raccourcis ci-dessous ne sont actifs que lorsque la disposition compacte est activée.

| Commande                 | 🍎 macOS        | 🟦 Windows            | 🐧 Linux              |
| :----------------------- | :-------------- | :-------------------- | :-------------------- |
| Voir les modifications Git| `PageUp`        | `PageUp`              | `PageUp`              |
...
<h2 align="center">⌨️ Raccourcis Généraux — Pro</h2>

| Commande                              | 🍎 macOS                | 🟦 Windows / 🐧 Linux        | Supporté |
| :------------------------------------ | :---------------------- | :--------------------------- | :------: |
| Ouvrir l'Explorateur                  | `⌘ + 1`                 | `Ctrl + 1`                   |    ✅    |
| Ouvrir le Contrôle de Source          | `⌘ + 2`                 | `Ctrl + 2`                   |    ✅    |
| SKILLS                                | `⌘ + 3`                 | `Ctrl + 3`                   |    ✅    |
...
| Basculer la Console de Débogage (REPL)| `⌥ + Q`                 | `Alt + Q`                    |    ✅    |
| -                                     | -                       | -                            |   N/A    |
...
| Copier les Lignes vers le Haut        | `⇧ + ⌥ + ↑`             | `Shift + Alt + ↑`            |    ✅    |
| Copier les Lignes vers le Bas         | `⇧ + ⌥ + ↓`             | `Shift + Alt + ↓`            |    ✅    |
| Insérer un Curseur au-dessus          | `⌘ + ↑`                 | `Ctrl + ↑`                   |    ✅    |
| Insérer un Curseur en dessous         | `⌘ + ↓`                 | `Ctrl + ↓`                   |    ✅    |
...
| -                                     | -                       | -                            |   N/A    |
| Panneau CLI (basculer)                | `⌥ + E`                 | `Alt + E`                    |    ✅    |
| Terminal Gauche/Droite (basculer)     | `⌥ + CapsLock`          | `Alt + CapsLock`             |    ✅    |
| Restaurer la Disposition par Défaut   | `⌘ + ⌥ + CapsLock`      | `Ctrl + Alt + CapsLock`      |    ✅    |
| Ouverture Rapide du Terminal          | `⌥ + W`                 | `Alt + W`                    |    ✅    |
| Agrandir / Réduire le Panneau         | <code>⌘ + \`</code>     | <code>Ctrl + \`</code>       |    ✅    |
...
| -                                     | -                       | -                            |   N/A    |
| **Fermeture Intelligente** — IA ou Trm| `⌘ + Tab`               | `Ctrl + Tab`                 |    ✅    |
| Créer une Nouvelle Session IA         | `⌥ + A`                 | `Alt + A`                    |    ✅    |
| Afficher l'Historique du Chat IA      | `⌥ + S`                 | `Alt + S`                    |    ✅    |
| Sélectionner du Code avec l'IA        | `⌥ + D`                 | `Alt + D`                    |    ✅    |
| -                                     | -                       | -                            |   N/A    |
| Annuler le Chat en Ligne              | `⌥ + Return`            | `Alt + Enter`                |    ✅    |
...
> Pour utiliser ces commandes, vous devez d'abord aller dans le **Contrôle de Source** (car elles ne fonctionnent pas directement) ou appuyer sur le raccourci **_`Ctrl + 2`_**.

| Commande                    | 🍎 macOS                | 🟦 Windows                       | 🐧 Linux                         |
| :-------------------------- | :---------------------- | :------------------------------- | :------------------------------- |
| Tout Indexer (Stage)        | `⌥ + 1`                 | `Alt + 1`                        | `Alt + 1`                        |
| Générer un Message Commit IA| `⌥ + 2`                 | `Alt + 2`                        | `Alt + 2`                        |
| Tout Désindexer (Unstage)   | `⌥ + 3`                 | `Alt + 3`                        | `Alt + 3`                        |
| Commit                      | `⌥ + Return`            | `Alt + Enter`                    | `Alt + Enter`                    |
| Push                        | `⌘ + ⌥ + Return`        | `Ctrl + Alt + Enter`             | `Ctrl + Alt + Enter`             |
| Voir les modifications Git  | `⌥ + L`                 | `Alt + L`                        | `Alt + L`                        |
...
| Commande                 | 🍎 macOS          | 🟦 Windows              | 🐧 Linux                |
| :----------------------- | :---------------- | :---------------------- | :---------------------- |
| Paramètres (UI)          | `⌘ + J`           | `Ctrl + J`              | `Ctrl + J`              |
| Paramètres (JSON)        | `⌥ + J`           | `Alt + J`               | `Alt + J`               |
| Sélectionner le Thème    | `⇧ + ⌥ + T`       | `Shift + Alt + T`       | `Shift + Alt + T`       |
| Recharger la Fenêtre     | `⇧ + ⌥ + R`       | `Shift + Alt + R`       | `Shift + Alt + R`       |
| Afficher Aperçu Markdown | `⌥ + M`           | `Alt + M`               | `Alt + M`               |
| Changer la Disposition   | `⌥ + 0`           | `Alt + 0`               | `Alt + 0`               |
| Zoom Avant               | `⇧ + ⌥ + VolUp`   | `Shift + Alt + VolUp`   | `Shift + Alt + VolUp`   |
| Zoom Arrière             | `⇧ + ⌥ + VolDown` | `Shift + Alt + VolDown` | `Shift + Alt + VolDown` |
...
| Commande                 | 🍎 macOS               | 🟦 Windows                    | 🐧 Linux                      |
| :----------------------- | :--------------------- | :---------------------------- | :---------------------------- |
| Échanger Terminal Projet | `Alt + Q - W`          | `Alt + Q - W`                 | `Alt + Q - W`                 |
| Fermer le Terminal       | `Alt + Q - E`          | `Alt + Q - E`                 | `Alt + Q - E`                 |
| Nouveau Terminal Intell. | <code>⌘ + ⇧ + `</code> | <code>Ctrl + Shift + `</code> | <code>Ctrl + Shift + `</code> |
| Tuer le Terminal         | <code>⌘ + ⌥ + `</code> | <code>Ctrl + Alt + `</code>   | <code>Ctrl + Alt + `</code>   |

<br>

> [!IMPORTANT]
>
> **L'`Accent Grave` = ( ` )** prend en charge toutes les dispositions de clavier 🌎
>
> ```ts
> exports.BACKTICK_EQUIVALENTS = [
>   { Backquote: "`" }, // Anglais, US
>   { Backquote: "º" }, // Espagnol (Espagne)
>   { Backquote: "'" }, // Français, Allemand
>   { Backquote: "²" }, // Français
>   { Backquote: "^" }, // Allemand, Suisse
>   { Backquote: "ё" }, // Russe
>   { Backquote: "~" }, // Portugais, Italien
>   { Backquote: "半角/全角" }, // Japonais
>   { Backquote: "|" }, // Espagnol (Amérique Latine)
>   { Backquote: "¬" }, // Royaume-Uni, Amérique Latine
>   { Backquote: "¨" }, // Allemand, Suédois
>   { Backquote: "´" }, // Portugais (Amérique Latine)
>   { Backquote: "₺" }, // Turc
>   { Backquote: "₤" }, // Italien
>   { Backquote: "" }, // Et PLUS ENCORE...
> ];
> ```
...
>
> Cette extension désactive intentionnellement les raccourcis VS Code par défaut suivants afin d'éviter les conflits :
>
> - **`Ctrl+P` / `⌘+P`** — Ouverture Rapide (désactivé pour empêcher les conflits avec des raccourcis personnalisés)
...
> ### Limitations Connues
>
> - **`Alt+CapsLock`** peut ne pas fonctionner sur certaines distributions Linux ou systèmes Windows où CapsLock est réassigné au niveau du système d'exploitation. Si ce raccourci ne fonctionne pas, vérifiez les paramètres du clavier de votre système ou utilisez des raccourcis alternatifs.
...
- 🐦 **[X](https://x.com/intent/follow?screen_name=gohitx)** : Pour les questions et les discussions.
- 🌱 **[IG](https://instagram.com/gohitx)** : **`nouveau`** – Aperçus de projets et nouvelles de la vie.
- 🔴 **[YouTube](https://www.youtube.com/@gohitx?sub_confirmation=1)** : Code, Logiciels et analyses de développement.
...
| ----------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![F1](https://open-vsx.org/api/bastndev/f1/1.0.0/file/icon.png)](https://open-vsx.org/extension/bastndev/f1)                             | [F1](https://github.com/bastndev/F1)                     | Le centre de contrôle IA ultime. Centralisez Claude, Copilot ou Cursor dans des terminaux interactifs, créez des flux de travail personnalisés avec 'My Skills' et offrez à l'IA un contexte immédiat de votre code grâce à 'My Memory'.              |
| [![Lynx Theme Pro](https://open-vsx.org/api/bastndev/lynx-theme/5.0.0/file/icon.png)](https://open-vsx.org/extension/bastndev/lynx-theme) | [Lynx Theme Pro](https://github.com/bastndev/Lynx-Theme) | Une extension professionnelle comprenant six thèmes disponibles : Dark, Light, Night, Ghibli, Coffee et Kiro — avec icônes intégrées. Chaque thème est optimisé pour offrir une expérience visuelle plus agréable.                                      |
| [![ATM](https://open-vsx.org/api/bastndev/atm/1.9.4/file/icon.png)](https://open-vsx.org/extension/bastndev/atm)                          | [ATM](https://github.com/bastndev/ATM)                   | Une boîte à outils tout-en-un 👻 qui booste votre flux de travail avec des fonctionnalités essentielles comme Error Lens, Git Blame, la Protection d'Env, et des captures d'écran de code à travers les éditeurs majeurs.                             |

<br>

<div align="center">

**Profitez 🎉 Lynx Keymap Pro est maintenant installé !**  
_Vous avez trouvé un bug ou avez des commentaires ? [Ouvrez un Issue](https://github.com/bastndev/Lynx-Keymap-pro/issues/new)_

<sub>Fabriqué au 🇵🇪 par <a href="https://gohit.xyz">Gohit X</a> · Sous licence <a href="https://github.com/bastndev/Lynx-Keymap-pro/blob/main/LICENSE">`MIT`</a></sub>
